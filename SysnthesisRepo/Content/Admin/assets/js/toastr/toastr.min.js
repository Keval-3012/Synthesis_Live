...
function checkVersion() {
    ...
    t > -1 && (n = t >= 8 ? "You're using a recent copy of Windows Internet Explorer." : "You should upgrade your copy of Windows Internet Explorer.");
    alert(n)
}
    ...
    n(["jquery"], function (n) {
        return function () {
            ...
            function u(r) {
                ...
                function d() {
                    (u.timeOut > 0 || u.extendedTimeOut > 0) && (p = setTimeout(a, u.extendedTimeOut))
                }
                ...
                var u = i(),
                    ...
                    k, s;
                typeof r.optionsOverride != "undefined" && (u = n.extend(u, r.optionsOverride), y = r.optionsOverride.iconClass || y);
                o++;
                t = f(u);
                var p = null,
                    e = n("<div/>"),
                ...
                return r.iconClass && e.addClass(u.toastClass).addClass(y), r.title && (w.append(r.title).addClass(u.titleClass), e.append(w)), r.message && (b.append(r.message).addClass(u.messageClass), e.append(b)), u.closeButton && (v.addClass("toast-close-button"), e.prepend(v)), u.positionClass && t.attr("class") != u.positionClass && (t.html(""), t.removeAttr("class"), t.addClass(u.positionClass)), e.hide(), u.newestOnTop ? t.prepend(e) : t.append(e), e[u.showMethod]({
                    ...
                    easing: u.showEasing,
                    complete: u.onShown
                }), u.timeOut > 0 && (p = setTimeout(a, u.timeOut)), e.hover(g, d), !u.onclick && u.tapToDismiss && e.click(a), u.closeButton && v && v.click(function (n) {
                    n.stopPropagation ? n.stopPropagation() : n.cancelBubble !== undefined && n.cancelBubble !== !0 && (n.cancelBubble = !0);
                    a(!0)
                }), u.onclick && e.click(function () {
                    u.onclick();
                    a()
                }), h(l), k = 0, k = 1, isIE8orlower() == 0 && (s = document.createElement("audio"), s.setAttribute("src", "assets/sound/alert.mp3"), n.get(), s.addEventListener("load", function () {
                    s.play()
                }, !0), s.pause(), s.play()), u.debug && console && console.log(l), e
            }
